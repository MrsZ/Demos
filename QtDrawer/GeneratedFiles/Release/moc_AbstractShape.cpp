...
static const char qt_meta_stringdata_AbstractShape[] = {
    "AbstractShape\0\0pen\0setPen(QPen)\0brush\0"
    "setBrush(QBrush)\0"
};
...
const QMetaObjectExtraData AbstractShape::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject AbstractShape::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AbstractShape,
      qt_meta_data_AbstractShape, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &AbstractShape::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_AbstractShape))
